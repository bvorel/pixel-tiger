...
function SpecRow({ specs }: { specs: [string, string][] }) {
  return (
    <div className="flex gap-5 mt-3 flex-wrap">
      {specs.map(([k, v]) => (
        <div key={k}>
          <p className="font-greycliff text-[9px] text-cream/30">{k}</p>
          <p className="font-greycliff text-xs font-medium text-cream">{v}</p>
        </div>
      ))}
    </div>
  );
...
const NAV_LINK_STYLES = [
  { label: "Default",      navBarBg: "#5EA288", navBarText: "#302E26", altMenuText: "#302E26" },
  { label: "Hover / Active", navBarBg: "#FF6222", navBarText: "#302E26", altMenuText: "#F5EFE3" },
];

function NavigationSection() {
  return (
    <section id="navigation" className="p-10">

      {/* MENU */}
      <div className="mb-12">
        <SubHeader title="Menu" />
        <p className="font-inter text-base text-white/90 mb-8">
          Nav content will span the full screen width.
        </p>

        {/* Closed state */}
        <div className="mb-6 border border-[rgba(128,128,128,0.4)] overflow-hidden">
          <div className="bg-sage flex items-center h-20 px-6 gap-4">
            <PixelTigerLogo variant="dark" className="h-10 w-auto shrink-0" />
            <span className="flex-1 min-w-0 truncate font-greycliff font-black text-espresso" style={{ fontSize: "26px", lineHeight: "1.4" }}>
              A full-service production, post, and print house.
            </span>
            <div className="flex flex-col gap-1.25 p-2 shrink-0">
        ...
        {/* Open state with dropdown */}
        <div className="border border-[rgba(128,128,128,0.4)] overflow-hidden">
          <div className="bg-sage flex items-center h-20 px-6 gap-4">
            <PixelTigerLogo variant="dark" className="h-10 w-auto shrink-0" />
            <span className="flex-1 min-w-0 truncate font-greycliff font-black text-espresso" style={{ fontSize: "26px", lineHeight: "1.4" }}>
              A full-service production, post, and print house.
          ...
          <div className="flex justify-end bg-espresso border-t border-[rgba(128,128,128,0.2)]">
            <div className="min-w-55 border-l border-[rgba(128,128,128,0.3)]">
              {["Production", "Social", "Digital", "Photography", "Post Production", "Print", "OOH"].map((item) => (
                <div key={item} className="font-greycliff font-black text-sm text-cream uppercase px-5 py-3 border-b border-[rgba(128,128,128,0.2)]">
                  {item}
                </div>
              ))}
              <div className="font-greycliff font-black text-sm text-orange uppercase px-5 py-3">
                Drop us a Line →
              </div>
            </div>
          </div>
      ...
      {/* ALT MENU */}
      <div className="mb-12">
        <SubHeader title="Alt Menu" />
        <p className="font-inter text-base text-white/90 mb-8">
          This option fills the screen.
        </p>
        <div className="bg-orange relative p-6 border border-[rgba(128,128,128,0.4)]">
          <div className="flex justify-between items-start mb-5">
            <PixelTigerLogo variant="dark" className="h-17.75 w-auto" />
            <div className="w-20 h-20 flex items-center justify-center shrink-0">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M2 2L18 18M18 2L2 18" stroke="#302e26" strokeWidth="2.5" strokeLinecap="square" />
              </svg>
          ...
          <div className="font-greycliff font-black text-espresso uppercase leading-[1.1] tracking-[-1px]">
            <div className="text-[36px]">PRODUCTION</div>
            <div className="text-[28px]">• SOCIAL + DIGITAL</div>
            <div className="text-[36px]">PHOTOGRAPHY +</div>
            <div className="text-[36px]">POST PRODUCTION</div>
            <div className="text-[36px]">PRINT • OOH</div>
          </div>
          <div className="mt-5">
            <span className="inline-flex items-center gap-2 bg-espresso text-orange px-6 py-4 font-greycliff font-black uppercase tracking-[0.75px] text-base">
              Drop us a Line →
            </span>
          </div>
        </div>
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {NAV_LINK_STYLES.map((state) => (
            <div key={state.label} className="border border-[rgba(128,128,128,0.4)] p-6">
              <p className="font-greycliff text-xs text-cream/50 uppercase tracking-[0.05em] mb-5">
                {state.label}
              </p>

              {/* Nav bar item */}
              <div className="px-4 py-3 mb-3" style={{ backgroundColor: state.navBarBg }}>
                <span className="font-greycliff font-black uppercase tracking-[-0.5px]"
                  style={{ fontSize: "26px", lineHeight: "1.2", color: state.navBarText }}>
                  Text
                </span>
              </div>
              <SpecRow specs={[
              ...
              {/* Alt menu item */}
              <div className="bg-orange px-4 py-3 mt-6 mb-3">
                <span className="font-greycliff font-black uppercase tracking-[-1px]"
                  style={{ fontSize: "40px", lineHeight: "1.1", color: state.altMenuText }}>
                  PRODUCTION
                </span>
              </div>
              <SpecRow specs={[
      ...
      {/* FAV ICON */}
      <div>
        <SubHeader title="Fav Icon" />
        <div className="overflow-hidden border border-[rgba(128,128,128,0.4)] shrink-0" style={{ width: "48px", height: "48px" }}>
          <PixelTigerLogo variant="dark" className="h-12 w-auto shrink-0" />
        </div>
      </div>
    </section>
  );
...
function FooterSection() {
  return (
    <section id="footer" className="p-10">

      <div className="mb-12">
        <p className="font-inter text-base text-white/90 mb-8">
          Desktop footer is within the Bootstrap grid.
        </p>

        {/* Desktop */}
        <div className="mb-8">
          <p className="font-greycliff text-xs text-cream/40 uppercase tracking-widest mb-4">Desktop</p>
          <div className="border border-[rgba(128,128,128,0.4)] overflow-hidden">
            <div className="bg-orange">
              <div className="flex gap-6 items-center justify-center px-3 py-8 max-w-285 mx-auto">
                <div className="flex-1 min-w-0">
                  <p className="font-greycliff font-black text-[20px] text-espresso leading-[1.2]">
                    Drop us a line:<br />
                    hello@pixeltiger.com
                  </p>
                </div>
                <div className="flex gap-6 shrink-0">
                  <div className="w-11.5 h-11.5 rounded-full bg-espresso flex items-center justify-center">
                ...
                <div className="flex-1 min-w-0 text-right">
                  <p className="font-greycliff font-black text-[20px] text-espresso leading-[1.2] text-right">
                    2700 Commerce St.<br />
                    Suite 100B<br />
                    Dallas, TX 75038
                  </p>
        ...
        {/* Mobile */}
        <div className="mb-8">
          <p className="font-greycliff text-xs text-cream/40 uppercase tracking-widest mb-4">Mobile</p>
          <div className="border border-[rgba(128,128,128,0.4)] overflow-hidden" style={{ maxWidth: 375 }}>
            <div className="bg-orange flex flex-col items-center gap-6 text-center px-3 py-8">
              <p className="font-greycliff font-black text-[18px] text-espresso leading-[1.2]">
                Drop us a line:<br />
                hello@pixeltiger.com
              </p>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {[
            { label: "Default",       underline: false },
            { label: "Hover / Active", underline: true  },
          ].map((state) => (
            <div key={state.label} className="border border-[rgba(128,128,128,0.4)] p-6">
              <p className="font-greycliff text-xs text-cream/50 uppercase tracking-[0.05em] mb-5">
                {state.label}
              </p>
              <div className="bg-orange p-5 mb-4">
                <p className="font-greycliff font-black text-[20px] text-espresso leading-[1.2]">
                  Drop us a line:<br />
                  <span className={state.underline ? "underline" : ""}>hello@pixeltiger.com</span>
                </p>
              </div>
              <p className="font-inter text-sm text-cream/60 mb-3">p-bold</p>
              <SpecRow specs={[
                ["Font", "Greycliff CF"],
                ["Weight", "Heavy"],
                ["Size", "20px"],
              ...
              {!state.underline && (
                <div className="flex gap-4 mt-4 flex-wrap">
                  <div>
                    <p className="font-greycliff text-[9px] text-cream/30">Text Color</p>
                    <div className="flex items-center gap-1">
                      <span className="w-2.5 h-2.5 inline-block bg-espresso" />
                      <p className="font-greycliff text-xs text-cream">#302E26</p>
                    </div>
                  </div>
                  <div>
                    <p className="font-greycliff text-[9px] text-cream/30">Background Color</p>
                    <div className="flex items-center gap-1">
                      <span className="w-2.5 h-2.5 inline-block bg-orange" />
                      <p className="font-greycliff text-xs text-cream">#FF6222</p>
                    </div>
                  </div>
                </div>
              )}
...
function SpacingSection() {
  return (
    <section id="spacing" className="p-10">
      <div className="mb-12">
        <SubHeader title="Layout Grid" />
        <p className="font-inter text-base text-white/90 mb-10">
          Site uses the Bootstrap grid.
        </p>

        {/* Desktop */}
        <div className="mb-12">
          <p className="font-greycliff text-xs text-cream/40 uppercase tracking-widest mb-6">Desktop</p>
          <div className="relative mb-6" style={{ maxWidth: 600 }}>
            <div className="border-t border-l border-r border-orange h-4" />
            <p className="font-inter text-[11px] text-cream/60 text-center mb-3">
              Screen Width 1280px
            </p>
            <div className="mx-3 border-t border-l border-r border-orange/50 h-4" />
            <p className="font-inter text-[11px] text-cream/40 text-center mb-4">
              Content Width 1140px
            </p>
            <div className="mx-3 flex gap-[24px]" style={{ height: 80 }}>
              {Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="flex-1 bg-[rgba(128,128,128,0.15)] border border-[rgba(128,128,128,0.25)]" />
              ))}
            </div>
            <div className="flex mx-3 mt-3 gap-6">
              <div>
                <p className="font-inter text-[10px] text-cream/40">Margin</p>
                <p className="font-inter text-[11px] text-cream/70">12px</p>
              </div>
              <div>
                <p className="font-inter text-[10px] text-cream/40">Gutter</p>
                <p className="font-inter text-[11px] text-cream/70">24px</p>
              </div>
            </div>
          </div>
          <SpecRow specs={[
        ...
        {/* Mobile */}
        <div>
          <p className="font-greycliff text-xs text-cream/40 uppercase tracking-widest mb-6">Mobile</p>
          <div className="relative mb-6" style={{ maxWidth: 220 }}>
            <div className="border-t border-l border-r border-orange h-4" />
            <p className="font-inter text-[11px] text-cream/60 text-center mb-3">
              Screen Width 375px
            </p>
